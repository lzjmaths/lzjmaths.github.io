...
\newpage
 ...
 $ \mathscr{L}=E-V $.  $ p_i=\dps\frac{\partial \mathscr{L}}{\partial \dot{q}_i} $ 
 
  $ \mathscr{H}=\dps\sum_{i=1}^np_i\dot{q}_i-\mathcal{L} $.
  
  Hamilton's equation:
  \[ \begin{cases}
    \dps\dot{q}_i=\frac{\partial \mathcal{H}}{\partial p_i}=\{q_i,\mathscr{H}\}\\
    \dps \dot{p}_i=-\frac{\partial \mathcal{H}}{\partial q_i}=\{p_i,\mathscr{H}\}
  \end{cases}\]
  Action  \[S=\dps\int_{t_0}^{t_1}\left(\sum_{i}p_i\dot{q}_i-\mathscr{H}\right)\dd t=\int_{t_0}^{t_1}\left(\sum_{i}p_i\dd q_i-\mathscr{H}\dd t\right) \]
  Poisson bracket:
  \[\{f,g\}=\sum_i\left(\frac{\partial f}{\partial q_i}\frac{\partial g}{\partial p_i}-\frac{\partial f}{\partial p_i}\frac{\partial g}{\partial q_i}\right)\]

  \[\frac{\dd}{\dd t}f=\{f,\mathscr{H}\}+\frac{\partial f}{\partial t}\]

  If  $ (q,p,t)\mapsto (Q,P,t) $ canonical transformation, with Hamiltonian  $ \mathscr{H},\mathscr{K} $ respectively. Then 
  \[
  \sum_{i}p_i\dd q_i-\mathscr{H}\dd t-\sum_{i}P_i\dd Q_i+\mathscr{K}\dd t=\dd F\]
  Type-1 generating function  $ F=F_1(q,Q,t) $. Type-2 generating function  $ F=F_2(q,P,t) $.
  
   $\dps\frac{\partial W}{\partial q}=p $. 
  \begin{theorem}
    Let  $ W(q,t) $ be the value of the action on the extrmal curve with fixed initial point and endpoint  $ (t,q) $. Then  $ W(q,t) $ satisfies Hamilton-Jacobi equation 
    \[\frac{\partial W}{\partial t}+\mathscr{H}(q,\frac{\partial W}{\partial q},t)\] 
  \end{theorem}
  If  $ W=W_0(q_1,\cdots,q_n,\alpha_1,\cdots,\alpha_n)-Et $,  $ \alpha_i $ constant of motions, then  $ \beta_i=\dps\frac{\partial W}{\partial \alpha_i} $.  $ (q,p)\mapsto(\alpha,\beta) $ canonical transformation with Hamiltonian $ \mathscr{K}=0 $. And  $ (q,p) $ can be represented by  $ (\alpha,\beta) $      
  Action-variation  $ I_i=\dps\int_{\gamma_i}\sum p_i\dd q_i $
  
  Generating function  $ S=\dps\int^q\sum p_k(\tilde{q},I)\dd\tilde{q} $.
  
  Action-angle  $ \theta(I,q)=\dps\frac{\partial S}{\partial I} $ 
