...
\begin{proof}
    ...
    \end{equation}
    Let  $ M=\dps\max\limits_{z\in \mathbb{C}}|f(z)| $.
    \begin{equation*}
        \begin{aligned}
...
So we have just proved an important result: Zeros of  analytic are isolated, or equivalently, we have a famous theorem:
