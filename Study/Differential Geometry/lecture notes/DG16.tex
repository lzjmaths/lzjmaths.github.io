...
\end{theorem}
\begin{proof}
     $ \forall \omega\in \Omega_c^{n-1}(M) $,  $ \omega=\omega_1+\cdots+\omega_k $,  $ \omega_j\int\Omega_s^n(M) $.
     ...
     By linearity, we may assume  $ \omega\in \Omega_s^n(M) $,  $ \Supp(\omega)\subset U_\alpha $ for chart  $ \varphi_\alpha:U_\alpha\xrightarrow{\cong}V_\alpha $.
      ...
      $ \varphi_\alpha^{-1,*}(\omega)\in\Omega_c^n(V_\alpha) $ induces  $ \omega'\in \Omega_c^n(\Rbb_{-}\times \Rbb^{n-1}) $ if we extend it by 0.
      
      By considering  $ \omega' $ instead of  $ \omega $, we may assume  $ M=\Rbb_{-}\times\Rbb^{n-1} $   
\end{proof}