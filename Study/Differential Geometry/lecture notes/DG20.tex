\begin{proof}
    ...
    Involutive  $ \Rightarrow  $ Completely integrable.  $ \forall p\in M  $, take local chart  $ (V,y^1,\cdots,y^n ) $. WLOG,  $ y(p)=0 $. Then  $ \pi=(y^1,\cdots,y^n):V\rightarrow \Rbb^k,p\mapsto \mathbf{0} $. It induces $ \pi_{q,*}:T_qV\rightarrow T_{\pi(q)}\Rbb^n=\Rbb^n $. 
    
    Since $ D_p$ has dimension   $ k $,
    by shrinking  $ V  $,   we may assume  $ \pi_{q,*}|_{D_q}:D_q\xrightarrow{\cong}\Rbb^k,\,\forall q\in V $.
...
\begin{proof}
    ...
    \[[\frac{\partial }{\partial x}+\alpha\frac{\partial}{\partial z},\frac{\partial }{\partial y}+\beta\frac{\partial }{\partial z}]=\frac{\partial \beta}{\partial x}+\alpha\frac{\partial \beta}{\partial z}-\frac{\partial \alpha}{\partial y}-\beta\frac{\partial\alpha}{\partial z}=0\]  
